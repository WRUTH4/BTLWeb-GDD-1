...
<table width="100%" border="1">
  ...
  <?php
  $i=1;
  while($dong=mysqli_fetch_array($row_timkiem,MYSQLI_ASSOC)){
  ...
  <tr>
	...
	$row_tinhtrang = mysqli_query($con,$sql_tinhtrang);
	$dong_tinhtrang=mysqli_fetch_array($row_tinhtrang,MYSQLI_ASSOC);
